...
from app_patched.models import Comment, Transaction, User
from app_patched.routes import api_bp, auth_bp, import_bp, main_bp, payments_bp, upload_bp
...
def seed_data():
    ...
    comment = Comment(user_id=1, text="Welcome to the secure app")
